...
public class GamePanel extends JPanel implements Runnable {
    ...
    public final int maxScreenCol = 16; // 16 horizontal tiles displayed
    public final int maxScreenRow = 12; // 12 vertical tiles displayed
    ...
    public void paintComponent(Graphics g) {
        ...
        tileManager.draw(g2d); // Draw before player, so player isn't hidden
        player.draw(g2d);
